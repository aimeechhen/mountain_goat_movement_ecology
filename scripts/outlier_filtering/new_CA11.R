...
goat$individual.local.identifier <- "CA11"
...
# 
# # round 1
# # 1b. look for outliers & plot
# # location points -> set the bounding box around the point, top right of the map, large offshoot, no other points in that area across all animals
...
# # looks like an outlier, the points before/after POI are in the same location, looks like a bad location, an offshoot
# plot(point_check$POI) # confirming these are the correct fixes within the bbox
# movement_map(point_check$POI) # and on the map
# 
