...
goat$individual.local.identifier <- "CA18"
...
out_data$flag_outlier <- ifelse(out_data$speed >= 0.10, 1, 0) # 0.20 = 18, 0.15= 34
# how many fixes were found above the plateau?
sum(out_data$flag_outlier) #0.2 = 18, 0.1 = 78
...
# save progress
save(out_data_good_loc_list, file = "./data/goat/cleaning/in_progress/out_data_good_loc_list_original_final.rda")
# clean environment
rm(list = ls())
gc()
...
# 
# #.........................................................
# # 5. do manual checks on good locations
# 
# library(paletteer)
# 
...
# out_data_good_loc_list[[1]] <- out_data
# 
# # move onto next goat
# 
