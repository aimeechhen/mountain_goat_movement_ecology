...
# Basic model -> movement parameters no interaction with any covariates
...
# Error in circular::dvonmises(x = plot_ta$x, kappa = low_ta$params$kappa,  : 
#                                the concentration parameter 'kappa' must be non negative
