...
goat_data <- goat_data[goat_data$year == "2023" | goat_data$year == "2024", ]
...
goat_data <- goat_data[goat_data$month_day >= fire_start & goat_data$month_day <= fire_end, ]
...
#create folders
saving_date <- "20250317"
folder_list <- c(
  # paste0("fits_", saving_date), 
