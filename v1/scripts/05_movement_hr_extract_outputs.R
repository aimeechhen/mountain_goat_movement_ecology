...
load("./scripts/working/data/movement_model/speed_mean_20250505.rda")
load("./scripts/working/data/movement_model/speeds_insta_20250505.rda")
...
# SAVE RESULTS ----
write.csv(RESULTS, file = "./scripts/working/data/combined_data_movement_hr_results_20250505_v2.csv", row.names = FALSE)
RESULTS <- read.csv("./scripts/working/data/combined_data_movement_hr_results_20250505_v2.csv")
