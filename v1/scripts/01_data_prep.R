...
# Data cleaning for the part of the collar data was completed by Stefano Mezzini
...
d <- readRDS("./scripts/working/data/collar_data/movement-models-akdes-goats-2024-06-07.rds")
...
pre08 <- collar_data[collar_data$collar_id == "30548" & collar_data$date < "2019-06-25",]
